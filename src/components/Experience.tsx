      ...
      <div className="max-w-7xl mx-auto">
              ...
              >
                ...
                <div className={`w-full md:w-5/12 ${index % 2 === 0 ? 'md:pr-8' : 'md:pl-8'} ml-12 md:ml-0`}>
                  ...
                  >
                    ...
                    <p className="retro-text opacity-90 mb-4 leading-relaxed text-sm">
                      {exp.description}
                    </p>
        ...
        >
          ...
          >
            ...
            <div className="retro-text font-retro">Years of Work Experience</div>
          </motion.div>
          <motion.div
            variants={itemVariants}
            className="text-center retro-card rounded-xl p-6"
          >
            ...
            <div className="retro-text font-retro">Research Internships at Johns Hopkins</div>
          </motion.div>
          <motion.div
            variants={itemVariants}
            className="text-center retro-card rounded-xl p-6"
          >
            ...
            <div className="retro-text font-retro">Different Organizations</div>
          </motion.div>
        </motion.div>
      </div>
    </section>
